...
import { MapPin, Phone, Mail, Clock, MessageCircle, HelpCircle, ArrowRight } from 'lucide-react';
              ...
              <div>
                ...
                <div className="space-y-4 md:space-y-6 mb-6 md:mb-8">
                  {[
                    ...
                    { icon: Mail, title: "Email Us", desc1: AMIGOS_EMAIL, desc2: "Use the contact form", color: "bg-[#FF4500]" },
              ...
              <form className="space-y-6" onSubmit={handleFormSubmit}>
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  >
                    ...
                    <motion.input
                      ...
                      name="firstName"
                      required
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1A2A44] focus:border-[#1A2A44] cursor-text"
                ...
                >
                  ...
                  <motion.select
                    id="service"
                    name="service"
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1A2A44] focus:border-[#1A2A44] cursor-pointer"
                    whileFocus={{ scale: 1.02 }}
                  >
                ...
                <motion.button
                  type="submit"
                  className="w-full px-6 py-3 bg-[#1A2A44] text-white font-semibold rounded-lg hover:shadow-lg transform hover:-translate-y-1 transition-all duration-300 flex items-center justify-center space-x-2 cursor-pointer"
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  ...
                  whileHover={{ 
                    scale: 1.02,
                    boxShadow: "0 10px 25px rgba(26, 42, 68, 0.3)"
                  }}
                  whileTap={{ scale: 0.98 }}
                >
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <motion.p 
              ...
              viewport={{ once: true }}
            >
              Find quick answers to the most common questions about our visa services.
            </motion.p>
          </div>
            ...
            {contactData.faqs.map((faq, index) => (
              ...
              >
                ...
                >
                  ...
                  >
                    <HelpCircle className="h-5 w-5 text-[#1A2A44]" />
                  </motion.div>
                </motion.button>
                <motion.div
                  animate={{ 
